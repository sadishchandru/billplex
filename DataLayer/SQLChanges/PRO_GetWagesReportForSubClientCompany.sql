...
-- Description:	<Wages Report For Sub client Company>
-- =============================================
-- Exec [PRO_GetWagesReportForSubClientCompany]
CREATE OR ALTER PROCEDURE [dbo].[PRO_GetWagesReportForSubClientCompany]
@From DATE = NULL,
@To DATE = NULL,
...
BEGIN
    ...
    (
        SELECT
			...
			EF.PFNo,
			EF.ESINo,
            SubClientCompany AS CompanyName,
			JGDC.subContractor,
    ...
    IF (@SubClientCompany <> '')
    BEGIN
        SET @Query = @Query + ' AND JGDC.CompanyName =  ''' + @SubClientCompany + '''';
    END
...
/*
EXEC [dbo].[PRO_GetWagesReportForSubClientCompany]
    @From = '2023-08-01',
    @To = '2023-09-25',
