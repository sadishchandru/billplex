...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[PRO_GetClientBankInfo]
...
SET NOCOUNT ON;
	...
	--EXEC(@Query)
			...
			SELECT 
					...
					Address
			FROM ClientBankInfo CBI
			inner join CompanyMasterInfo CMI on CMI.Id = CBI.MainCompanyId
			inner join ClientMaster CM on CM.Id = CBI.ClientCompanyId
END