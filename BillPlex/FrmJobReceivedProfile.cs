...
namespace BillPlex
{
    public partial class FrmJobReceivedProfile : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void gridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            JobReceivedInfoRequest = new FrmJobReceivedInfo();

            JobReceivedInfoRequest.BindData(SubClientGrid);
            JobReceivedInfoRequest.MdiParent = this.MdiParent;
            JobReceivedInfoRequest.Show();

            var selectedRow = gridView1.GetSelectedRows();
          JobReceivedInfoRequest = new FrmJobReceivedInfo();         
          JobReceivedInfoRequest.BindData(gridView1);
          JobReceivedInfoRequest.MdiParent = this.MdiParent;
          JobReceivedInfoRequest.Show();
        }
    }
