    ...
    public partial class FrmCustomerMaster : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    XtraMessageBox.Show("please give the mandatory field", "Alert ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            int centerX = (this.Width - panelControl6.Width) / 2;
            int centerY = (this.Height - panelControl6.Height) / 2;
            panelControl6.Location = new Point(centerX, centerY);
        }
    }
}