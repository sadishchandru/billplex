...
namespace BillPlex
{
    public partial class FrmJobReallocation : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            // Get the entered employee code from the TextBox
            string employeeCode = txtEmployeeCode.Text.Trim();

            //// Set the parameter value of the SqlDataSource (assuming you have a parameter named "EmployeeCode")
            //sqlDataSource1.SelectCommandParameters.Clear();
            //sqlDataSource1.SelectCommandParameters.AddWithValue("@EmployeeCode", employeeCode);

            // Set the parameter value of the SqlDataSource (using question mark placeholder)
            //sqlDataSource1.SelectParameters.Clear();
            //sqlDataSource1.SelectParameters.Add(new DevExpress.DataAccess.Sql.QueryParameter("param1", employeeCode));

            // Refresh the SqlDataSource data (this will automatically update the GridView)
            sqlDataSource1.FillAsync();
        }
