    ...
    public partial class FrmJobReceivedInfo : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void BindData(dynamic selectedCompanyList)
        {
            ...
            foreach (var rowHandle in selectedRows)
            {
                ...
                txtEmpName.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "EmployeeName");
                txtCName.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "CompanyName");
                txtRawMaterial.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "RawMaterial");
                txtQuantity.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "TotalQty");
                txtType.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "Type");
                txtWeight.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "BalanceWt");
                txtPModel.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "ModelName");
                txtPCode.Text = (string)selectedCompanyList.GetRowCellValue(rowHandle, "ModelCode");
                ...
                JobReceivedRequest.ClientCompany = (string)selectedCompanyList.GetRowCellValue(rowHandle, "ClientCompany");
                JobReceivedRequest.ClientCompanyName = (string)selectedCompanyList.GetRowCellValue(rowHandle, "ClientName");
                ...
                txtWages.Enabled = false;
                txtPQty.Enabled = false;
                txtMName.Enabled = false;
                txtType.Enabled = false;
                txtWeight.Enabled = false;
                txtCrntWt.Enabled = false;
                txtRcvdQty.Enabled = false;
                ddReceDate.Enabled = false;
                txtPModel.Enabled = false;
                txtPCode.Enabled = false;
                txtPSize.Enabled = false;
                txtColor.Enabled = false;
                txtBeforeDys.Enabled = false;
                txtAfterdys.Enabled = false;
