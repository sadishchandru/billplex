...
namespace BillPlex
{
    public partial class FrmDirectJobGivingProfile : DevExpress.XtraEditors.XtraForm
    {
        public FrmDirectJobGivingProfile()
        {
            InitializeComponent();
        }

        private void FrmDirectJobGivingProfile_Load(object sender, EventArgs e)
        {
